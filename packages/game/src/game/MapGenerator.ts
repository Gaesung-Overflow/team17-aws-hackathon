...
export class MapGenerator {
  static createEmptyMap(width: number, height: number): Position[] {
    return [];
  }
  ...
  static createRandomWalls(width: number, height: number, density: number = 0.2): Position[] {
    const walls = this.createBorderWalls(width, height);
  ...
  // 팩맨 스타일 맵
  static createPacmanMap(): { walls: Position[], mapSize: { width: number, height: number } } {
    const pattern = [
      "####################",
      "#..................#",
      "#.##.#######.####.#",
